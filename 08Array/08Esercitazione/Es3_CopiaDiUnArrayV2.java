...
public class Es3_CopiaDiUnArrayV2 {
    ...
    public static void main(String[] args) {
        ...
        String[] newArrayStringBis = new String[LENGTH];
        ...
        for(int i = 0; i < arrayString.length; i++) {
            ...
            newArrayString[i] = arrayString[arrayString.length-1-i];
            
            newArrayStringBis[arrayString.length-1-i] = arrayString[i];
        }

        System.out.println(Arrays.toString(arrayString));
        System.out.println(Arrays.toString(newArrayString));
        System.out.println(Arrays.toString(newArrayStringBis));
        ...
        [mai, mia, momo, moo, bee, aii, oii, hoi, mah, boh]
        */
    }
