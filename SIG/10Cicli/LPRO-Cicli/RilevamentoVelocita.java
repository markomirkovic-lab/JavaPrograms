...
public class RilevamentoVelocita {
    ...
    public static void main(String[] args) {
        ...
        if(deltaVelocita <= 0) {
            multa = 0;
            denuncia = false;
        } else if(deltaVelocita >= 1 && deltaVelocita <= 5) {
            multa = 40;
            denuncia = false;
        } else if(deltaVelocita >= 6 && deltaVelocita <= 10) {
            multa = 120;
            denuncia = false;
        } else if(deltaVelocita >= 11 && deltaVelocita <= 15) {
            multa = 250;
            denuncia = false;
        } else if(deltaVelocita >= 16) {
            multa = 0;
            denuncia = true;
        }
