...
public class Es11_8_1_InserireInCimaV2 {
    ...
    public static void main(String[] args) {
        ...
        for(origine = 0; origine < array.length; origine++) {   // scorriamo tutti gli elementi dell'array di origine
            ...
            destinazione = origine+1;                           // siccome l'array di destinazione e' piu' grande di una
                                                                // cella, tutti gli elementi vanno spostati a destra di
                                                                // una posizione

            tmp[destinazione] = array[origine];                 // copiamo l'elemento con gli indici giusti
        }

        destinazione = 0;                                       // calcoliamo la posizione della prima cella
        //destinazione = cella;
