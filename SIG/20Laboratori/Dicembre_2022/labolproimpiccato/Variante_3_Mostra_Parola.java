...
public class Variante_3_Mostra_Parola 
{
    public static void main(String[] args) 
    {
        ...
        do
        {
            ...
            //ggg: Mostro la parola con le lettere indovinate
            String status= "";
            for(int i=0; i<parola.length(); i++)
            {
                if( lettereTrovate.indexOf(parola.charAt(i))==-1 )
                {
                    status= status + "_";
                }
                else
                {
                    status= status + parola.charAt(i);
                }                    
            }
        ...
        //Verifico se è uscito dal ciclo con una vittoria e no
        System.out.println("=================================================");
