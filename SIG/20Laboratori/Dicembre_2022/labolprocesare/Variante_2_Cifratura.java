...
/** ggg:
 * Partendo dalla versione precedente, vado a inserire il codice per cifrare. Cercate la stringa //ggg:
 */
public class Variante_2_Cifratura 
{
    public static void main(String[] args) 
    {
        ...
        {            
            ...
            if(opzione=='C' || opzione=='D')                                        //Oppure if(opzione!='X')
            {
                ...
                //ggg: da qui in poi troverete l'algortimo di cifratura
