...
public class Variante_1_Calcolo_Resto
{
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            //Ok, ora so di avere un double, vado a vedere se partendo dalla moneta più grande posso distribuire un resto
            
            //Se provate ad esempio 123.55 vedrete un errore dato dai double
            ...
            if(resto>=5)
            {
                monete= (int)(resto/5);
                resto= resto%5;
                System.out.println(monete + " pezzi da 5fr");
            }                                   
