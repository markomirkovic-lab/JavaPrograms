...
public class Variante_4_Calcolo_Resto_ConteggioMonete
{
    public static void main(String[] args)
    {
        ...
        int[]    cent=      {  500,   200,   100,      50,      20,      10,      5};
        String[] centFrase= {"5fr", "2fr", "1fr", "50cts", "20cts", "10cts", "5cts"};
        int[]    quanti=    {    1,     1,     1,      10,       1,      10,     20};
        ...
        do
        {
            ...
            for(int i=0; i<cent.length; i++)
            {
                if(resto>=cent[i])
                {
                    ...
                    System.out.println(monete + " pezzi da " + centFrase[i] + "\tne restano: " + quanti[i]);
                }
            }
