...
class Libro {
    ...
    Libro deepCopia() {
        String copiaTitolo = this.titolo == null ? null : new String(this.titolo); // `new String` non è strettamente necessario
                                                                                   // perché gli oggetti di tipo String
                                                                                   // sono immutable.
        Persona copiaAutore = this.autore == null ? null : this.autore.deepCopia(); // richiamo la copia deep dell'oggetto di tipo Persona
...
public class BibliotecaTestV4 {
    ...
    public static void main(String[] args) {
        ...
        Libro libro3 = new Libro("Titolo 3", new Persona("Nome 3", "Nome 3", 21), 5);
        libro3.stampa();
        System.out.println();
        ...
        Biblioteca biblioteca = new Biblioteca(new Persona("Luca", "Verdi", 22), 5);
        ...
        Libro[] libri = {
                ...
                new Libro("Titolo 5", new Persona("Nome 5", "Cognome 5", 44), 12)
        };
