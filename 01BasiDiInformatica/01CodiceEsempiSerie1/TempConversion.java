/**
 * Programma che converte la temperatura da Celsius a Fahrenheit. La temperatura
...
public class TempConversion {
	...
	public static void main(String[] args) {
		if (args.length < 1) {
			System.out
					.println("La temperatura da convertire deve essere passata come parametro al lancio. Ad esempio: java TempConversion 10.5");
			return;
		}
		if (args.length > 1)
			System.out
					.println("L'applicazione richiede un solo parametro; tutti gli altri sono ignorati.");
