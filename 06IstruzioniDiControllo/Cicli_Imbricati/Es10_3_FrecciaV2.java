    ...
    public static void main(String[] args) {
        ...
        if(base % 2 != 0) {
            ...
            for(int riga = 1; riga < base/2; riga++) {
                ...
                /*
                   ...
                   if                                                   
                                                1 for      2 for 
                   r    c  base riga <= base/2  colonna <= b/2-c-1     inizio        fine
                   1       7    1       3                               "*"           "*"    
                        1                       1       <= 3-1-1=1          " "              * *
                   ----------------------------------------------------------------------
                   2      7    2       3                                "*"           "*"
        ...
        if(base % 2 == 0) {
            ...
            for(int riga = 1; riga <= base/2-1; riga++) {
                ...
                punta iniziale                                  "*"                  *
                            1 for               2 for 
                r    c  base riga <= base/3  colonna <= riga-1  inizio        fine
                1       6    1       2                          "*"           "*"    **
                    1                        1       <= 1-1=0       
                ------------------------------------------------------------------
                2       6    2       2                           "*"           "*"
            ...
            for(int riga = 1; riga < base/2 ; riga++) {
                ...
                /*
                   ...
                   punta iniziale                                  "*"                       *                                       
                                                1 for      2 for 
                   r    c  base riga <= base/2  colonna <= b/3-r-1     inizio        fine
                   1       6    1       3                               "*"           "*"    **  
                        1                       1       <= 2-1-1=0                          
                   ----------------------------------------------------------------------
                   2       6    2       3                                "*"           "*"
