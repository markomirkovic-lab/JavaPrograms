...
public class ArrayDecoderV1Bis {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sizeDiffer(a, b): " + sizeDiffer(a, b)); // false
        System.out.println();

        int index = indexOfUnique(a, 'b');
        System.out.println("indexOfUnique(a, 'b'): " + index); // 1

        System.out.println("isPermutation(a, b): " + isPermutation(a, b)); // true

        int[] indexArray = decode(a, b);
        System.out.println("indexArray: " + Arrays.toString(indexArray)); // [1, 0, 2]

        System.out.println();

        // Testing:
        // Ritorna solo le eventuali eccezzioni
        ...
        try {
            ...
            System.out.println("isPermutation(a5, b5): " + e.getMessage()); // Lunghezze diverse
        }
        ...
        try {
            ...
            System.out.println("decode(a3, b3): " + e.getMessage()); // Lunghezze diverse
        }
    }
}