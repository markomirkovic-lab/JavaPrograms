/*
Questo codice dimostra come trovare parole nascoste nelle colonne di una matrice 
e come gestire casi in cui le righe hanno lunghezze diverse.
Spiegazione del codice:
getMaxWidth(char[][] table):
Questo metodo scorre tutte le righe della matrice e trova la lunghezza massima 
...
corretto funzionamento. Vengono create due matrici di esempio e vengono testati 
...
public class VerticalCrosswordV3 {
    ...
    public static int searchInCols(char[][] table, String word) {
        ...
        for(int column = 0; column < maxWidth; column++) {
            ...
            String columnString = getColAsString(table, column).toLowerCase();
